...
@section('content')
        <form action="{{ route('dashboard.store-study-list') }}" method="post" class="w-[80%] flex flex-col items-center gap-y-2 rounded-3xl p-4 bg-white outline-2 outline-lightBorder shadow-xl">
            @csrf
            ...
            <div class="input-wrapper w-full flex flex-col rounded-2xl p-4">
                ...
                <x-dashboard_component.form.error name="title" />
            </div>
            ...
            <div class="input-wrapper w-full flex flex-col rounded-2xl p-4">
                ...
                <x-dashboard_component.form.error name="description" />
            </div>

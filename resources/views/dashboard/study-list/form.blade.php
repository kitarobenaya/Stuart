...
@section('content')
        <form action="{{ route('dashboard.store-study-list') }}" method="post" class="w-[80%] flex flex-col items-center rounded-3xl p-4 bg-white outline-2 outline-lightBorder shadow-xl">
            ...
            <div class="two-row-input flex flex-row justify-center items-center h-fit w-full">
                ...
                <div class="input-wrapper w-full flex flex-col rounded-2xl p-4">
                    <label for="time1" class="text-lg font-semibold text-black">Time</label>
                    <input type="time" name="time1" id="time1" class="bg-lightPrimary p-1 w-full text-base placeholder:text-gray-400 focus:outline-lightAccent focus:outline-2 rounded-lg text-black">
                </div>
                ...
                <div class="input-wrapper w-full flex flex-col rounded-2xl p-4">
                    <label for="time2" class="text-lg font-semibold">Time 2</label>
                    <input type="time" name="time2" id="time2" class="bg-lightPrimary p-1 w-full text-base placeholder:text-gray-400 focus:outline-lightAccent focus:outline-2 rounded-lg text-black">
                </div>
